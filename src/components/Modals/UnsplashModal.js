  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Content className="bg-theme-tertiaryBackground rounded-xl overflow-hidden shadow-xl transform transition-all w-[85%] h-3/4 lg:w-2/5 sm:w-1/2 pt-5 pl-5 pr-3 flex flex-col">
            <Dialog.Title />
